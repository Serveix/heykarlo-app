...
public class LoginActivity extends AppCompatActivity implements LoaderCallbacks<Cursor> {
    ...
    public class UserLoginTask extends AsyncTask<Void, Void, Boolean> {
        ...
        private String[] resultFromServer = new String[3];
        ...
        protected Boolean doInBackground(Void... params) {
            ...
            HKRestClient.syncPost("api/user/login", loginParams, new JsonHttpResponseHandler(){
                @Override
                public void onSuccess(int statusCode, Header[] headers, JSONObject responseBody) {
                    ...
                    try
                    {
                        ...
                        resultFromServer[1] = responseBody.getString("field");
                        resultFromServer[2] = responseBody.getString("value");
                        Log.i("RESPUESTA DEL SERVIDOR", responseBody.toString() );
                    }
        ...
        protected void onPostExecute(final Boolean success) {
            ...
            if (success) {
                sessionToken = resultFromServer[2];
                ...
                Log.d("SERVER RESPONSE", resultFromServer[0]);
                if(resultFromServer[0].equals("error")) {
                    switch(resultFromServer[1]) {
                        case "email":
                            Log.i("SERVER RESPONSE", resultFromServer[2]);
                            mEmailView.setError( resultFromServer[2] );
                            mEmailView.requestFocus();
                            break;
                        case "password":
                            Log.i("SERVER RESPONSE", resultFromServer[2]);
                            mPasswordView.setError( resultFromServer[2] );
